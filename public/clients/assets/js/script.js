/*-----------------------------------------------------------------------------------
    ...
    Template URI: https://webtend.net/demo/html/Goya/
    Author: WebTend
...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $(".price-slider-range").slider({
            ...
            min: 550000,
            max: 30000000,
            values: [0, 20000000], // Giá trị mặc định ban đầu
            slide: function (event, ui) {
                // Format số khi kéo slider
                let minPrice = ui.values[0].toLocaleString('vi-VN');
                let maxPrice = ui.values[1].toLocaleString('vi-VN');
                $("#price").val(minPrice + "đ - " + maxPrice + "đ");
            }
        });

        // Format số cho lần hiển thị đầu tiên khi vừa load trang
        let initialMin = $(".price-slider-range").slider("values", 0).toLocaleString('vi-VN');
        let initialMax = $(".price-slider-range").slider("values", 1).toLocaleString('vi-VN');
        $("#price").val(initialMin + "đ - " + initialMax + "đ");
    }
