...
<head>
   ...
   <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/material-design-iconic-font/2.2.0/css/material-design-iconic-font.min.css">
    ...
    <link rel="stylesheet" href="{{ asset('clients/assets/css_login/jquery.datetimepicker.min.css') }}">
     <link rel="stylesheet" href="{{ asset('clients/assets/css/user_infor.css') }}">
                    ...
                    <div class="header-inner rel d-flex align-items-center">
                        <div class="logo-outer">
                            <div class="logo"><a href="{{ route('home') }}"><img
                                        src="{{ asset('clients/assets/images/logos/logo-2.png') }}" alt="Logo"
                                        title="Logo"></a></div>
                        </div>
                            ...
                            <nav class="main-menu navbar-expand-lg">
                                <div class="navbar-header">
                                    <div class="mobile-logo">
                                        <a href="{{ route('home') }}">
                                            <img src="{{ asset('clients/assets/images/logos/logo-2.png') }}"
                                                alt="Logo" title="Logo">
                                        </a>
                                    </div>
                        ...
                        <div class="menu-btns py-10">
                            ...
                            <div class="menu-sidebar">
                                <button class="bg-transparent user-btn" id="userToggle">
                                    <i class="bx bx-user" style="font-size:24px; color: black;"></i>
                                </button>
